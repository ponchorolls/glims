...
// 	// Create a dynamic status bar based on state
// 	switch m.state {
// 	case stateSearch:
// 		statusLine = lipgloss.NewStyle().Background(blue).Foreground(lipgloss.Color("15")).Render(" SEARCH ")
// 	case stateAdd:
// 		statusLine = lipgloss.NewStyle().Background(green).Foreground(lipgloss.Color("0")).Render(" ADD ITEM ")
// 	case stateDeleteConfirm:
// 		statusLine = lipgloss.NewStyle().Background(red).Foreground(lipgloss.Color("15")).Render(" CONFIRM DELETE ")
// 	default:
// 		statusLine = lipgloss.NewStyle().Background(gray).Foreground(lipgloss.Color("15")).Render(" NAVIGATE ")
// 	}

// 	// Build the UI string
// 	ui := fmt.Sprintf(
// 		"%s %s\n\n%s\n\n%s",
// 		headerStyle.Render("GLIMS v1.0"),
// 		statusLine,
// 		baseStyle.Render(m.table.View()),
// 		footerStyle.Render(" [/] Search • [n] New • [d] Delete • [esc] Reset • [ctrl+c] Quit"),
// 	)
...
// 		return fmt.Sprintf(
// 			"\n  %s\n\n  %s\n  %s\n\n  %s\n  %s\n\n  %s",
// 			lipgloss.NewStyle().Foreground(lipgloss.Color("205")).Render("ADD NEW ITEM"),
// 			"Product Name:",
// 			m.textInput.View(),
// 			"Quantity:",
// 			m.qtyInput.View(),
...
// 	switch m.state {
// 	case stateSearch:
// 		modeIndicator = lipgloss.NewStyle().Foreground(lipgloss.Color("205")).Render(" SEARCH MODE ")
// 	default:
// 		modeIndicator = lipgloss.NewStyle().Foreground(lipgloss.Color("86")).Render(" NAV MODE ")
// 	}

// 	helpView := "\n [/] search • [n] new • [d] delete • [q] quit"
